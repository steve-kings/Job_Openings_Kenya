...
export default function ContactPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-[#5CB800] via-[#5CB800] to-[#4A9900] text-white py-16 lg:py-20">
            ...
            <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 border-t-4 border-[#5CB800]">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#5CB800] to-[#5CB800] flex items-center justify-center">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                */}
                                ...
                                <input type="hidden" name="subject" value="New Contact Form Submission from Job Openings Kenya Website" />
                                <input type="hidden" name="from_name" value="Job Openings Kenya Contact Form" />
                                ...
                                <div className="grid md:grid-cols-2 gap-5">
                                    <div className="form-control">
                                        ...
                                        <input
                                            ...
                                            className="input input-bordered w-full focus:border-[#5CB800] focus:outline-none focus:ring-2 focus:ring-[#5CB800]/20"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-5">
                                    ...
                                    <div className="form-control">
                                        ...
                                        <select
                                            ...
                                            className="select select-bordered w-full focus:border-[#5CB800] focus:outline-none focus:ring-2 focus:ring-[#5CB800]/20"
                                            required
                                        >
                                ...
                                <div className="form-control">
                                    ...
                                    <textarea
                                        name="message"
                                        className="textarea textarea-bordered h-40 focus:border-[#5CB800] focus:outline-none focus:ring-2 focus:ring-[#5CB800]/20"
                    ...
                    <div className="space-y-6">
                        {/* Email Card */}
                        <div className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-[#5CB800] hover:shadow-2xl transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-12 h-12 rounded-full bg-[#5CB800]/10 flex items-center justify-center">
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:partners@Job Openings Kenya.org" className="text-[#5CB800] font-semibold hover:text-[#5CB800] transition-colors">
                                        partners@Job Openings Kenya.org
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-6 border-l-4 border-[#5CB800] hover:shadow-2xl transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-12 h-12 rounded-full bg-[#5CB800]/10 flex items-center justify-center">
                                    <Phone className="text-[#5CB800]" size={24} />
                                </div>
                        ...
                        {/* WhatsApp Card */}
                        <div className="bg-gradient-to-br from-[#5CB800] to-[#4A9900] text-white rounded-2xl shadow-xl p-6 hover:shadow-2xl transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                            ...
                            <p className="mb-4 text-white/90">
                                Get daily opportunities, updates, and connect with other youth across Kenya.
                            </p>
                            <a
