...
export default async function BlogPage() {
    ...
    const categoryColors: { [key: string]: { bg: string; text: string; border: string } } = {
        'Success Stories': { bg: 'bg-[#10B981]', text: 'text-[#10B981]', border: 'border-[#10B981]' },
        'Career Tips': { bg: 'bg-[#F39C12]', text: 'text-[#F39C12]', border: 'border-[#F39C12]' },
        'Opportunities': { bg: 'bg-[#C44536]', text: 'text-[#C44536]', border: 'border-[#C44536]' },
        'News': { bg: 'bg-[#8B3A3A]', text: 'text-[#8B3A3A]', border: 'border-[#8B3A3A]' },
    };

    const getCategoryColor = (category: string) => {
        return categoryColors[category] || { bg: 'bg-[#C44536]', text: 'text-[#C44536]', border: 'border-[#C44536]' };
    };

    return (
        <div className="bg-white">
            {/* Hero Section */}
            <div className="relative min-h-[400px] bg-gradient-to-br from-gray-900 via-[#8B3A3A] to-[#C44536] text-white overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10 py-20 lg:py-28">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 bg-[#F39C12] text-white px-6 py-2 rounded-full text-sm font-semibold mb-6">
                            <BookOpen size={18} />
                            <span>YENA Blog</span>
                        </div>
                        <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                            Stories, Insights &
                            <span className="block text-[#F39C12]">Community Updates</span>
                        </h1>
                ...
                <div className="py-12 bg-white">
                    <div className="container mx-auto px-6 lg:px-12">
                        <div className="flex items-center gap-2 mb-6">
                            <TrendingUp className="text-[#C44536]" size={24} />
                        ...
                        <Link href={`/blog/${featuredPost.slug}`}>
                            <div className="grid lg:grid-cols-2 gap-8 bg-gradient-to-br from-gray-50 to-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 group border-2 border-gray-100">
                                <div className="relative h-96 lg:h-auto overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                        <div className="relative">
                                            ...
                                            <div className="absolute -top-3 -left-3 w-16 h-0.5 bg-[#F39C12] opacity-50 rotate-[-15deg]"></div>
                                            <div className="absolute -bottom-3 -right-3 w-16 h-0.5 bg-[#C44536] opacity-50 rotate-[-15deg]"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 lg:p-12 flex flex-col justify-center">
                                    ...
                                    <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 group-hover:text-[#C44536] transition-colors">
                                        {featuredPost.title}
                                    </h3>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2 text-[#C44536] font-semibold group-hover:gap-3 transition-all">
            ...
            <div className="py-20 bg-gradient-to-r from-[#C44536] to-[#8B3A3A] text-white">
                <div className="container mx-auto px-6 lg:px-12 text-center">
                    ...
                    <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                        Have an inspiring journey or valuable insights to share with the YENA community? We'd love to feature your story!
                    </p>
                    <a 
                        href="mailto:stories@yena.org" 
