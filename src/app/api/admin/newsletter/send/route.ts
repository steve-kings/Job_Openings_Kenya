    ...
    try {
        ...
        <head>
            ...
            <style>
                ...
                .header { background-color: #1976D2; color: #ffffff; padding: 40px 30px; text-align: center; }
                ...
                .btn { display: inline-block; padding: 12px 24px; background-color: #1976D2; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; text-align: center; margin-top: 10px; width: 100%; box-sizing: border-box; }
        ...
        <body>
            <div class="container">
                <div class="header">
                    <img src="${logoUrl}" alt="1000Jobs Logo">
                    <h1>Your Weekly Opportunities</h1>
                    <p>The top 5 hand-picked roles for you this week.</p>
                </div>
                
                <div class="content">
                    <p class="intro">Hello there! Here is your curated list of the latest high-impact opportunities on the 1000Jobs platform. Don't miss out—apply before the deadlines!</p>
                    ...
                    <div style="text-align: center; margin-top: 40px;">
                        <a href="${siteUrl}/jobs" style="color: #1976D2; font-weight: 600; text-decoration: underline; font-size: 16px;">View All 1000+ Opportunities</a>
                    </div>
                </div>
                
                <div class="footer">
                    <p>You're receiving this email because you subscribed to the 1000Jobs Weekly Opportunities.</p>
                    <p>&copy; ${new Date().getFullYear()} 1000Jobs. All rights reserved.<br>Empowering African Youth</p>
                </div>
            </div>
        </body>
        </html>
        ...
        for (let i = 0; i < bccList.length; i += chunkSize) {
            ...
            await sendEmail({
                to: [{ email: 'info.1000jobs@gmail.com', name: '1000Jobs Admin' }],
                bcc: chunk,
                subject: '🔥 Your Weekly Top 5 Opportunities - 1000Jobs',
