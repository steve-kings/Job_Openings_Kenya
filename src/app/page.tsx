...
export default async function Home() {
  ...
  // Fetch real success stories from blog (Success Story category)
  const { data: successStories } = await supabase
    .from('blog_posts')
    .select('id, title, excerpt, featured_image, author_name, slug, category')
    .eq('status', 'published')
  ...
  return (
    <div className="flex flex-col bg-white">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-medium">
              Daily Verified Jobs • No Scams • 100% Free
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/jobs" className="btn bg-[#1976D2] text-white hover:bg-[#1565C0] btn-lg px-8 border-none">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              {/* Decorative accent */}
              <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-[#4CAF50] rounded-full opacity-10 blur-3xl -z-10"></div>
            </div>
            ...
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                ...
                <span className="relative inline-block ml-2">
                  ...
                  <span className="absolute bottom-1 left-0 w-full h-3 bg-[#4CAF50] -z-0"></span>
                </span>
              </h2>
              
              <p className="text-gray-600 leading-relaxed mb-6">
                Since our inception, 1000Jobs has been at the forefront of youth empowerment across Africa. We've connected thousands of young Africans with life-changing opportunities, from scholarships to job placements, grants to training programs.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/about" className="btn bg-[#1976D2] text-white hover:bg-[#1565C0] px-8 border-none">
                  About us →
                </Link>
                <a 
      ...
      <div className="py-24 bg-gray-900 text-white relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#4CAF50] rounded-full opacity-10 blur-3xl"></div>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <a href="https://kings-learn.vercel.app" target="_blank" rel="noopener noreferrer" className="btn bg-[#1976D2] text-white hover:bg-[#1565C0] border-none btn-lg px-8">
                Browse Courses →
              </a>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-4">
              Real stories from real people whose lives have been transformed through 1000Jobs
            </p>
          </div>

          {/* Stories from DB */}
          {!successStories || successStories.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-2xl shadow-lg col-span-3">
              <p className="text-gray-500 text-lg">Success stories coming soon!</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {successStories.map((story) => (
                <Link key={story.id} href={`/blog/${story.slug}`} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 group">
                  <div className="h-64 overflow-hidden relative">
                    <img src={story.featured_image || '/images/img7.jpg'} alt={story.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    <div className="absolute top-4 right-4 w-16 h-16 bg-[#4CAF50] rounded-full opacity-60 blur-2xl"></div>
                    <div className="absolute top-4 left-4">
                      <span className="bg-[#4CAF50] text-white px-3 py-1 rounded-full text-xs font-semibold">{story.category}</span>
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#1976D2] transition-colors line-clamp-2">{story.title}</h3>
                    <p className="text-gray-700 italic leading-relaxed text-sm line-clamp-3">"{story.excerpt}"</p>
                    <p className="text-xs text-gray-500 mt-3">— {story.author_name}</p>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div className="text-center mt-12">
            <Link href="/blog" className="btn bg-[#1976D2] text-white hover:bg-[#1565C0] px-8 border-none">
              Read More Stories
            </Link>
          </div>
        </div>
      ...
      <div className="py-24 bg-white border-t-8 border-[#4CAF50]">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/jobs" className="btn bg-[#1976D2] text-white hover:bg-[#1565C0] btn-lg border-none px-10">
